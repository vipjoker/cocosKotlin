...
import com.vipjokerstudio.cocoskotlin.core.protocol.CCKeyDelegateProtocol;
...
public class CCLayer extends CCNode
    ...
    protected CCLayer() {
    	...
    	sensorManager = (SensorManager) Director.getInstance().getActivity().getSystemService(Context.SENSOR_SERVICE);
...
//        setAnchorPoint(Vec2.make(0.5f, 0.5f));
        setContentSize(s);
        setRelativeAnchorPoint(false);
