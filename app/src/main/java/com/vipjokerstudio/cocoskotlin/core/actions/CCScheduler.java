...
//	Method			    impMethod;
    ...
    */
    ...
    private static CCScheduler scheduler = null;
...
//        }
//        for(ConcurrentHashMap<Object, tHashSelectorEntry>.Entry e = hashForSelectors.firstValue(); e != null; e = hashForSelectors.nextValue(e)) {
